---
name: impeccable
description: Any frontend UI work — design, redesign, audit, polish, animate, or fix any interface element. Covers visual hierarchy, UX, accessibility, tokens, motion, copy, and edge states. Not for backend-only tasks.
---
